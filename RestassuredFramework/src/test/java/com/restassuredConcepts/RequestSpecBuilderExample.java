...
package com.restassuredConcepts;
...
public class RequestSpecBuilderExample {
	...
	public static void main(String[] args) {
		...
		// Creating an object of RequestSpecBuilder this is the first class
		RequestSpecBuilder reqBuilder = new RequestSpecBuilder();
		// Setting Base URI
		reqBuilder.setBaseUri("https://restful-booker.herokuapp.com");
		// Setting Base Path
		reqBuilder.setBasePath("/booking");
		// Getting RequestSpecification reference using build() method  RequestSpecification is Second class involved
